...
parser.add_argument("--trycatch", default=False, action="store_true")
...
generate(funcs, headername, args.namespace, args.implementation, args.docstring, trycatch=args.trycatch)
