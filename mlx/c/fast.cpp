...
extern "C" mlx_array mlx_fast_affine_dequantize(
    ...
    int bits,
    mlx_stream s) {
  RETURN_MLX_C_PTR(new mlx_array_((mlx::core::fast::affine_dequantize(
...
extern "C" mlx_array mlx_fast_affine_quantize(
    ...
    int bits,
    mlx_stream s) {
  RETURN_MLX_C_PTR(new mlx_array_((mlx::core::fast::affine_quantize(
      w->ctx, scales->ctx, biases->ctx, group_size, bits, s->ctx))));
}
extern "C" mlx_array mlx_fast_layer_norm(
    ...
    float eps,
    mlx_stream s) {
  RETURN_MLX_C_PTR(new mlx_array_((mlx::core::fast::layer_norm(
      x->ctx,
...
extern "C" mlx_closure_metal_kernel_function mlx_fast_metal_kernel(
    ...
    bool atomic_outputs) {
  RETURN_MLX_C_PTR(
      new mlx_closure_metal_kernel_function_((mlx::core::fast::metal_kernel(
          MLX_CPP_STRING(name),
...
extern "C" mlx_array mlx_fast_rope(
    ...
    mlx_array freqs,
    mlx_stream s) {
  RETURN_MLX_C_PTR(new mlx_array_((mlx::core::fast::rope(
      x->ctx,
      dims,
      traditional,
...
extern "C" mlx_array mlx_fast_scaled_dot_product_attention(
    ...
    mlx_stream s) {
  RETURN_MLX_C_PTR(
      new mlx_array_((mlx::core::fast::scaled_dot_product_attention(
          queries->ctx,
          keys->ctx,
          values->ctx,
          scale,
