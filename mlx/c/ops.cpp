...
extern "C" int mlx_arange(mlx_array* res, double stop, const mlx_stream s) {
  try {
    mlx_array_set_(*res, mlx::core::arange(stop, mlx_stream_get_(s)));
  } catch (std::exception& e) {
    mlx_error(e.what());
    return 1;
  }
...
extern "C" int
mlx_argsort(mlx_array* res, const mlx_array a, int axis, const mlx_stream s) {
  try {
    mlx_array_set_(
...
extern "C" int
mlx_argsort_all(mlx_array* res, const mlx_array a, const mlx_stream s) {
  try {
    mlx_array_set_(
...
extern "C" int mlx_eye(mlx_array* res, int n, const mlx_stream s) {
  try {
    mlx_array_set_(*res, mlx::core::eye(n, mlx_stream_get_(s)));
  } catch (std::exception& e) {
    mlx_error(e.what());
    return 1;
  }
...
extern "C" int
mlx_flatten(mlx_array* res, const mlx_array a, const mlx_stream s) {
  try {
    mlx_array_set_(
        *res, mlx::core::flatten(mlx_array_get_(a), mlx_stream_get_(s)));
  } catch (std::exception& e) {
    mlx_error(e.what());
    return 1;
  }
...
extern "C" int
mlx_sort(mlx_array* res, const mlx_array a, int axis, const mlx_stream s) {
  try {
    mlx_array_set_(
...
extern "C" int
mlx_sort_all(mlx_array* res, const mlx_array a, const mlx_stream s) {
  try {
    mlx_array_set_(
...
extern "C" int
mlx_topk_all(mlx_array* res, const mlx_array a, int k, const mlx_stream s) {
  try {
    mlx_array_set_(
...
extern "C" int
mlx_transpose_all(mlx_array* res, const mlx_array a, const mlx_stream s) {
  try {
    mlx_array_set_(
...
extern "C" int
mlx_tri(mlx_array* res, int n, mlx_dtype type, const mlx_stream s) {
  try {
    mlx_array_set_(
        *res, mlx::core::tri(n, mlx_dtype_to_cpp(type), mlx_stream_get_(s)));
  } catch (std::exception& e) {
    mlx_error(e.what());
    return 1;
  }
