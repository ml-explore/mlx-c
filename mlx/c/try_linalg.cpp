...
mlx_linalg_try_cholesky(mlx_array a, bool upper, mlx_stream s) {
  MLX_C_ARRAY_TRY(mlx::core::linalg::cholesky(a->ctx, upper, s->ctx))
}
extern "C" mlx_array_result mlx_linalg_try_inv(mlx_array a, mlx_stream s) {
  MLX_C_ARRAY_TRY(mlx::core::linalg::inv(a->ctx, s->ctx))
}
extern "C" mlx_array_result mlx_linalg_try_norm_p(
    mlx_array a,
    double ord,
    const int* axis,
    size_t num_axis,
...
extern "C" mlx_array_result mlx_linalg_try_norm_ord(
    mlx_array a,
    mlx_string ord,
    const int* axis,
    size_t num_axis,
...
extern "C" mlx_array_result mlx_linalg_try_norm(
    mlx_array a,
    const int* axis,
    size_t num_axis,
    bool keepdims,
...
extern "C" mlx_vector_array_result mlx_linalg_try_qr(
    mlx_array a,
    mlx_stream s) {
  MLX_C_ARRAYPAIR_TRY(mlx::core::linalg::qr(a->ctx, s->ctx))
}
extern "C" mlx_vector_array_result mlx_linalg_try_svd(
    mlx_array a,
    mlx_stream s) {
