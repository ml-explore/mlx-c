...
extern "C" mlx_array_result mlx_try_abs(mlx_array a, mlx_stream s) {
  MLX_C_ARRAY_TRY(mlx::core::abs(a->ctx, s->ctx))
}
extern "C" mlx_array_result
mlx_try_add(mlx_array a, mlx_array b, mlx_stream s) {
  MLX_C_ARRAY_TRY(mlx::core::add(a->ctx, b->ctx, s->ctx))
}
extern "C" mlx_array_result mlx_try_addmm(
    mlx_array c,
    mlx_array a,
    mlx_array b,
    float alpha,
...
extern "C" mlx_array_result mlx_try_all_axes(
    mlx_array a,
    const int* axes,
    size_t num_axes,
    bool keepdims,
...
extern "C" mlx_array_result
mlx_try_all_all(mlx_array a, bool keepdims, mlx_stream s) {
  MLX_C_ARRAY_TRY(mlx::core::all(a->ctx, keepdims, s->ctx))
}
extern "C" mlx_array_result mlx_try_allclose(
    mlx_array a,
    mlx_array b,
    double rtol,
    double atol,
...
extern "C" mlx_array_result mlx_try_any(
    mlx_array a,
    const int* axes,
    size_t num_axes,
    bool keepdims,
...
extern "C" mlx_array_result
mlx_try_any_all(mlx_array a, bool keepdims, mlx_stream s) {
  MLX_C_ARRAY_TRY(mlx::core::any(a->ctx, keepdims, s->ctx))
}
extern "C" mlx_array_result mlx_try_arange(
    double start,
    double stop,
    double step,
...
extern "C" mlx_array_result mlx_try_arccos(mlx_array a, mlx_stream s) {
  MLX_C_ARRAY_TRY(mlx::core::arccos(a->ctx, s->ctx))
}
extern "C" mlx_array_result mlx_try_arccosh(mlx_array a, mlx_stream s) {
  MLX_C_ARRAY_TRY(mlx::core::arccosh(a->ctx, s->ctx))
}
extern "C" mlx_array_result mlx_try_arcsin(mlx_array a, mlx_stream s) {
  MLX_C_ARRAY_TRY(mlx::core::arcsin(a->ctx, s->ctx))
}
extern "C" mlx_array_result mlx_try_arcsinh(mlx_array a, mlx_stream s) {
  MLX_C_ARRAY_TRY(mlx::core::arcsinh(a->ctx, s->ctx))
}
extern "C" mlx_array_result mlx_try_arctan(mlx_array a, mlx_stream s) {
  MLX_C_ARRAY_TRY(mlx::core::arctan(a->ctx, s->ctx))
}
extern "C" mlx_array_result
mlx_try_arctan2(mlx_array a, mlx_array b, mlx_stream s) {
  MLX_C_ARRAY_TRY(mlx::core::arctan2(a->ctx, b->ctx, s->ctx))
}
extern "C" mlx_array_result mlx_try_arctanh(mlx_array a, mlx_stream s) {
...
extern "C" mlx_array_result
mlx_try_argmax_all(mlx_array a, bool keepdims, mlx_stream s) {
...
extern "C" mlx_array_result
mlx_try_argmin_all(mlx_array a, bool keepdims, mlx_stream s) {
...
extern "C" mlx_array_result
mlx_try_argpartition_all(mlx_array a, int kth, mlx_stream s) {
  MLX_C_ARRAY_TRY(mlx::core::argpartition(a->ctx, kth, s->ctx))
}
extern "C" mlx_array_result
mlx_try_argsort(mlx_array a, int axis, mlx_stream s) {
  MLX_C_ARRAY_TRY(mlx::core::argsort(a->ctx, axis, s->ctx))
}
extern "C" mlx_array_result mlx_try_argsort_all(mlx_array a, mlx_stream s) {
...
extern "C" mlx_array_result mlx_try_as_strided(
    mlx_array a,
    const int* shape,
    size_t num_shape,
...
extern "C" mlx_array_result mlx_try_atleast_1d(mlx_array a, mlx_stream s) {
  MLX_C_ARRAY_TRY(mlx::core::atleast_1d(a->ctx, s->ctx))
}
extern "C" mlx_array_result mlx_try_atleast_2d(mlx_array a, mlx_stream s) {
  MLX_C_ARRAY_TRY(mlx::core::atleast_2d(a->ctx, s->ctx))
}
extern "C" mlx_array_result mlx_try_atleast_3d(mlx_array a, mlx_stream s) {
  MLX_C_ARRAY_TRY(mlx::core::atleast_3d(a->ctx, s->ctx))
}
extern "C" mlx_array_result
mlx_try_bitwise_and(mlx_array a, mlx_array b, mlx_stream s) {
  MLX_C_ARRAY_TRY(mlx::core::bitwise_and(a->ctx, b->ctx, s->ctx))
}
extern "C" mlx_array_result
mlx_try_bitwise_or(mlx_array a, mlx_array b, mlx_stream s) {
  MLX_C_ARRAY_TRY(mlx::core::bitwise_or(a->ctx, b->ctx, s->ctx))
}
extern "C" mlx_array_result
mlx_try_bitwise_xor(mlx_array a, mlx_array b, mlx_stream s) {
  MLX_C_ARRAY_TRY(mlx::core::bitwise_xor(a->ctx, b->ctx, s->ctx))
}
extern "C" mlx_array_result mlx_try_block_masked_mm(
    mlx_array a,
    mlx_array b,
    int block_size,
    mlx_array mask_out,
...
extern "C" mlx_vector_array_result mlx_try_broadcast_arrays(
    const mlx_vector_array inputs,
    mlx_stream s) {
  MLX_C_ARRAYS_TRY(mlx::core::broadcast_arrays(MLX_CPP_ARRVEC(inputs), s->ctx))
}
extern "C" mlx_array_result mlx_try_broadcast_to(
    mlx_array a,
    const int* shape,
    size_t num_shape,
    mlx_stream s) {
...
extern "C" mlx_array_result mlx_try_ceil(mlx_array a, mlx_stream s) {
...
extern "C" mlx_array_result mlx_try_concatenate_all(
    const mlx_vector_array arrays,
    mlx_stream s) {
  MLX_C_ARRAY_TRY(mlx::core::concatenate(MLX_CPP_ARRVEC(arrays), s->ctx))
}
extern "C" mlx_array_result mlx_try_conjugate(mlx_array a, mlx_stream s) {
  MLX_C_ARRAY_TRY(mlx::core::conjugate(a->ctx, s->ctx))
}
extern "C" mlx_array_result mlx_try_conv1d(
    mlx_array input,
    mlx_array weight,
    int stride,
    int padding,
...
extern "C" mlx_array_result mlx_try_conv2d(
    mlx_array input,
    mlx_array weight,
    int f_stride,
    int s_stride,
...
extern "C" mlx_array_result mlx_try_conv3d(
    mlx_array input,
    mlx_array weight,
    int stride_0,
    int stride_1,
...
extern "C" mlx_array_result mlx_try_conv_general(
    mlx_array input,
    mlx_array weight,
    const int* stride,
    size_t num_stride,
...
extern "C" mlx_array_result mlx_try_copy(mlx_array a, mlx_stream s) {
  MLX_C_ARRAY_TRY(mlx::core::copy(a->ctx, s->ctx))
}
extern "C" mlx_array_result mlx_try_cos(mlx_array a, mlx_stream s) {
  MLX_C_ARRAY_TRY(mlx::core::cos(a->ctx, s->ctx))
}
extern "C" mlx_array_result mlx_try_cosh(mlx_array a, mlx_stream s) {
  MLX_C_ARRAY_TRY(mlx::core::cosh(a->ctx, s->ctx))
}
extern "C" mlx_array_result mlx_try_cummax(
    mlx_array a,
    int axis,
    bool reverse,
    bool inclusive,
...
extern "C" mlx_array_result mlx_try_cummin(
    mlx_array a,
    int axis,
    bool reverse,
    bool inclusive,
...
extern "C" mlx_array_result mlx_try_cumprod(
    mlx_array a,
    int axis,
    bool reverse,
    bool inclusive,
...
extern "C" mlx_array_result mlx_try_cumsum(
    mlx_array a,
    int axis,
    bool reverse,
    bool inclusive,
...
extern "C" mlx_array_result mlx_try_degrees(mlx_array a, mlx_stream s) {
  MLX_C_ARRAY_TRY(mlx::core::degrees(a->ctx, s->ctx))
}
extern "C" mlx_vector_array_result mlx_try_depends(
    const mlx_vector_array inputs,
    const mlx_vector_array dependencies) {
  MLX_C_ARRAYS_TRY(
      mlx::core::depends(MLX_CPP_ARRVEC(inputs), MLX_CPP_ARRVEC(dependencies)))
}
extern "C" mlx_array_result mlx_try_dequantize(
    mlx_array w,
    mlx_array scales,
    mlx_array biases,
    int group_size,
...
extern "C" mlx_array_result mlx_try_diag(mlx_array a, int k, mlx_stream s) {
...
extern "C" mlx_array_result
mlx_try_divide(mlx_array a, mlx_array b, mlx_stream s) {
  MLX_C_ARRAY_TRY(mlx::core::divide(a->ctx, b->ctx, s->ctx))
}
extern "C" mlx_vector_array_result
mlx_try_divmod(mlx_array a, mlx_array b, mlx_stream s) {
  MLX_C_ARRAYS_TRY(mlx::core::divmod(a->ctx, b->ctx, s->ctx))
}
extern "C" mlx_array_result
mlx_try_equal(mlx_array a, mlx_array b, mlx_stream s) {
  MLX_C_ARRAY_TRY(mlx::core::equal(a->ctx, b->ctx, s->ctx))
}
extern "C" mlx_array_result mlx_try_erf(mlx_array a, mlx_stream s) {
  MLX_C_ARRAY_TRY(mlx::core::erf(a->ctx, s->ctx))
}
extern "C" mlx_array_result mlx_try_erfinv(mlx_array a, mlx_stream s) {
  MLX_C_ARRAY_TRY(mlx::core::erfinv(a->ctx, s->ctx))
}
extern "C" mlx_array_result mlx_try_exp(mlx_array a, mlx_stream s) {
  MLX_C_ARRAY_TRY(mlx::core::exp(a->ctx, s->ctx))
}
extern "C" mlx_array_result mlx_try_expand_dims(
    mlx_array a,
    const int* axes,
    size_t num_axes,
    mlx_stream s) {
...
extern "C" mlx_array_result mlx_try_expm1(mlx_array a, mlx_stream s) {
...
extern "C" mlx_array_result mlx_try_floor(mlx_array a, mlx_stream s) {
  MLX_C_ARRAY_TRY(mlx::core::floor(a->ctx, s->ctx))
}
extern "C" mlx_array_result
mlx_try_floor_divide(mlx_array a, mlx_array b, mlx_stream s) {
  MLX_C_ARRAY_TRY(mlx::core::floor_divide(a->ctx, b->ctx, s->ctx))
}
extern "C" mlx_array_result mlx_try_full(
    const int* shape,
    size_t num_shape,
    mlx_array vals,
    mlx_array_dtype dtype,
...
extern "C" mlx_array_result mlx_try_gather(
    mlx_array a,
...
extern "C" mlx_array_result mlx_try_gather_mm(
    mlx_array a,
    mlx_array b,
...
extern "C" mlx_array_result mlx_try_gather_qmm(
    mlx_array x,
    mlx_array w,
    mlx_array scales,
    mlx_array biases,
...
extern "C" mlx_array_result
mlx_try_greater(mlx_array a, mlx_array b, mlx_stream s) {
  MLX_C_ARRAY_TRY(mlx::core::greater(a->ctx, b->ctx, s->ctx))
}
extern "C" mlx_array_result
mlx_try_greater_equal(mlx_array a, mlx_array b, mlx_stream s) {
  MLX_C_ARRAY_TRY(mlx::core::greater_equal(a->ctx, b->ctx, s->ctx))
}
extern "C" mlx_array_result
mlx_try_identity(int n, mlx_array_dtype dtype, mlx_stream s) {
  MLX_C_ARRAY_TRY(mlx::core::identity(n, MLX_CPP_ARRAY_DTYPE(dtype), s->ctx))
}
extern "C" mlx_array_result
mlx_try_inner(mlx_array a, mlx_array b, mlx_stream s) {
  MLX_C_ARRAY_TRY(mlx::core::inner(a->ctx, b->ctx, s->ctx))
}
extern "C" mlx_array_result mlx_try_isclose(
    mlx_array a,
    mlx_array b,
    double rtol,
    double atol,
...
extern "C" mlx_array_result mlx_try_isinf(mlx_array a, mlx_stream s) {
  MLX_C_ARRAY_TRY(mlx::core::isinf(a->ctx, s->ctx))
}
extern "C" mlx_array_result mlx_try_isnan(mlx_array a, mlx_stream s) {
  MLX_C_ARRAY_TRY(mlx::core::isnan(a->ctx, s->ctx))
}
extern "C" mlx_array_result mlx_try_isneginf(mlx_array a, mlx_stream s) {
  MLX_C_ARRAY_TRY(mlx::core::isneginf(a->ctx, s->ctx))
}
extern "C" mlx_array_result mlx_try_isposinf(mlx_array a, mlx_stream s) {
  MLX_C_ARRAY_TRY(mlx::core::isposinf(a->ctx, s->ctx))
}
extern "C" mlx_array_result
mlx_try_left_shift(mlx_array a, mlx_array b, mlx_stream s) {
  MLX_C_ARRAY_TRY(mlx::core::left_shift(a->ctx, b->ctx, s->ctx))
}
extern "C" mlx_array_result
mlx_try_less(mlx_array a, mlx_array b, mlx_stream s) {
  MLX_C_ARRAY_TRY(mlx::core::less(a->ctx, b->ctx, s->ctx))
}
extern "C" mlx_array_result
mlx_try_less_equal(mlx_array a, mlx_array b, mlx_stream s) {
  MLX_C_ARRAY_TRY(mlx::core::less_equal(a->ctx, b->ctx, s->ctx))
}
extern "C" mlx_array_result mlx_try_linspace(
    double start,
    double stop,
    int num,
    mlx_array_dtype dtype,
...
extern "C" mlx_array_result mlx_try_log(mlx_array a, mlx_stream s) {
  MLX_C_ARRAY_TRY(mlx::core::log(a->ctx, s->ctx))
}
extern "C" mlx_array_result mlx_try_log10(mlx_array a, mlx_stream s) {
  MLX_C_ARRAY_TRY(mlx::core::log10(a->ctx, s->ctx))
}
extern "C" mlx_array_result mlx_try_log1p(mlx_array a, mlx_stream s) {
  MLX_C_ARRAY_TRY(mlx::core::log1p(a->ctx, s->ctx))
}
extern "C" mlx_array_result mlx_try_log2(mlx_array a, mlx_stream s) {
  MLX_C_ARRAY_TRY(mlx::core::log2(a->ctx, s->ctx))
}
extern "C" mlx_array_result
mlx_try_logaddexp(mlx_array a, mlx_array b, mlx_stream s) {
  MLX_C_ARRAY_TRY(mlx::core::logaddexp(a->ctx, b->ctx, s->ctx))
}
extern "C" mlx_array_result
mlx_try_logical_and(mlx_array a, mlx_array b, mlx_stream s) {
  MLX_C_ARRAY_TRY(mlx::core::logical_and(a->ctx, b->ctx, s->ctx))
}
extern "C" mlx_array_result mlx_try_logical_not(mlx_array a, mlx_stream s) {
  MLX_C_ARRAY_TRY(mlx::core::logical_not(a->ctx, s->ctx))
}
extern "C" mlx_array_result
mlx_try_logical_or(mlx_array a, mlx_array b, mlx_stream s) {
  MLX_C_ARRAY_TRY(mlx::core::logical_or(a->ctx, b->ctx, s->ctx))
}
extern "C" mlx_array_result mlx_try_logsumexp(
    mlx_array a,
    const int* axes,
    size_t num_axes,
    bool keepdims,
...
extern "C" mlx_array_result
mlx_try_matmul(mlx_array a, mlx_array b, mlx_stream s) {
  MLX_C_ARRAY_TRY(mlx::core::matmul(a->ctx, b->ctx, s->ctx))
}
extern "C" mlx_array_result mlx_try_max(
    mlx_array a,
    const int* axes,
    size_t num_axes,
    bool keepdims,
...
extern "C" mlx_array_result
mlx_try_max_all(mlx_array a, bool keepdims, mlx_stream s) {
  MLX_C_ARRAY_TRY(mlx::core::max(a->ctx, keepdims, s->ctx))
}
extern "C" mlx_array_result
mlx_try_maximum(mlx_array a, mlx_array b, mlx_stream s) {
  MLX_C_ARRAY_TRY(mlx::core::maximum(a->ctx, b->ctx, s->ctx))
}
extern "C" mlx_array_result mlx_try_mean(
    mlx_array a,
    const int* axes,
    size_t num_axes,
    bool keepdims,
...
extern "C" mlx_array_result
mlx_try_mean_all(mlx_array a, bool keepdims, mlx_stream s) {
  MLX_C_ARRAY_TRY(mlx::core::mean(a->ctx, keepdims, s->ctx))
}
extern "C" mlx_vector_array_result mlx_try_meshgrid(
    const mlx_vector_array arrays,
    bool sparse,
    mlx_string indexing,
    mlx_stream s) {
...
extern "C" mlx_array_result mlx_try_min(
    mlx_array a,
    const int* axes,
    size_t num_axes,
    bool keepdims,
...
extern "C" mlx_array_result
mlx_try_min_all(mlx_array a, bool keepdims, mlx_stream s) {
  MLX_C_ARRAY_TRY(mlx::core::min(a->ctx, keepdims, s->ctx))
}
extern "C" mlx_array_result
mlx_try_minimum(mlx_array a, mlx_array b, mlx_stream s) {
...
extern "C" mlx_array_result
mlx_try_multiply(mlx_array a, mlx_array b, mlx_stream s) {
  MLX_C_ARRAY_TRY(mlx::core::multiply(a->ctx, b->ctx, s->ctx))
}
extern "C" mlx_array_result mlx_try_negative(mlx_array a, mlx_stream s) {
  MLX_C_ARRAY_TRY(mlx::core::negative(a->ctx, s->ctx))
}
extern "C" mlx_array_result
mlx_try_not_equal(mlx_array a, mlx_array b, mlx_stream s) {
  MLX_C_ARRAY_TRY(mlx::core::not_equal(a->ctx, b->ctx, s->ctx))
}
extern "C" mlx_array_result mlx_try_number_of_elements(
    mlx_array a,
    const int* axes,
    size_t num_axes,
    bool inverted,
...
extern "C" mlx_array_result mlx_try_ones(
    const int* shape,
    size_t num_shape,
    mlx_array_dtype dtype,
    mlx_stream s) {
...
extern "C" mlx_array_result mlx_try_ones_like(mlx_array a, mlx_stream s) {
  MLX_C_ARRAY_TRY(mlx::core::ones_like(a->ctx, s->ctx))
}
extern "C" mlx_array_result
mlx_try_outer(mlx_array a, mlx_array b, mlx_stream s) {
  MLX_C_ARRAY_TRY(mlx::core::outer(a->ctx, b->ctx, s->ctx))
}
extern "C" mlx_array_result mlx_try_pad(
    mlx_array a,
    const int* axes,
    size_t num_axes,
...
extern "C" mlx_array_result
mlx_try_partition_all(mlx_array a, int kth, mlx_stream s) {
  MLX_C_ARRAY_TRY(mlx::core::partition(a->ctx, kth, s->ctx))
}
extern "C" mlx_array_result
mlx_try_power(mlx_array a, mlx_array b, mlx_stream s) {
  MLX_C_ARRAY_TRY(mlx::core::power(a->ctx, b->ctx, s->ctx))
}
extern "C" mlx_array_result mlx_try_prod(
    mlx_array a,
    const int* axes,
    size_t num_axes,
    bool keepdims,
...
extern "C" mlx_array_result
mlx_try_prod_all(mlx_array a, bool keepdims, mlx_stream s) {
...
extern "C" mlx_array_result mlx_try_quantized_matmul(
    mlx_array x,
    mlx_array w,
    mlx_array scales,
    mlx_array biases,
...
extern "C" mlx_array_result mlx_try_radians(mlx_array a, mlx_stream s) {
  MLX_C_ARRAY_TRY(mlx::core::radians(a->ctx, s->ctx))
}
extern "C" mlx_array_result mlx_try_reciprocal(mlx_array a, mlx_stream s) {
  MLX_C_ARRAY_TRY(mlx::core::reciprocal(a->ctx, s->ctx))
}
extern "C" mlx_array_result
mlx_try_remainder(mlx_array a, mlx_array b, mlx_stream s) {
...
extern "C" mlx_array_result
mlx_try_repeat_all(mlx_array arr, int repeats, mlx_stream s) {
...
extern "C" mlx_array_result
mlx_try_right_shift(mlx_array a, mlx_array b, mlx_stream s) {
  MLX_C_ARRAY_TRY(mlx::core::right_shift(a->ctx, b->ctx, s->ctx))
}
extern "C" mlx_array_result
mlx_try_round(mlx_array a, int decimals, mlx_stream s) {
  MLX_C_ARRAY_TRY(mlx::core::round(a->ctx, decimals, s->ctx))
}
extern "C" mlx_array_result mlx_try_rsqrt(mlx_array a, mlx_stream s) {
  MLX_C_ARRAY_TRY(mlx::core::rsqrt(a->ctx, s->ctx))
}
extern "C" mlx_array_result mlx_try_scatter(
    mlx_array a,
    const mlx_vector_array indices,
    mlx_array updates,
    const int* axes,
...
extern "C" mlx_array_result mlx_try_scatter_add(
    mlx_array a,
    const mlx_vector_array indices,
    mlx_array updates,
    const int* axes,
...
extern "C" mlx_array_result mlx_try_scatter_max(
    mlx_array a,
    const mlx_vector_array indices,
    mlx_array updates,
    const int* axes,
...
extern "C" mlx_array_result mlx_try_scatter_min(
    mlx_array a,
    const mlx_vector_array indices,
    mlx_array updates,
    const int* axes,
...
extern "C" mlx_array_result mlx_try_scatter_prod(
    mlx_array a,
    const mlx_vector_array indices,
    mlx_array updates,
    const int* axes,
...
extern "C" mlx_array_result mlx_try_sigmoid(mlx_array a, mlx_stream s) {
  MLX_C_ARRAY_TRY(mlx::core::sigmoid(a->ctx, s->ctx))
}
extern "C" mlx_array_result mlx_try_sign(mlx_array a, mlx_stream s) {
  MLX_C_ARRAY_TRY(mlx::core::sign(a->ctx, s->ctx))
}
extern "C" mlx_array_result mlx_try_sin(mlx_array a, mlx_stream s) {
  MLX_C_ARRAY_TRY(mlx::core::sin(a->ctx, s->ctx))
}
extern "C" mlx_array_result mlx_try_sinh(mlx_array a, mlx_stream s) {
  MLX_C_ARRAY_TRY(mlx::core::sinh(a->ctx, s->ctx))
}
extern "C" mlx_array_result mlx_try_slice(
    mlx_array a,
    const int* start,
    size_t num_start,
    const int* stop,
...
extern "C" mlx_array_result mlx_try_slice_update(
    mlx_array src,
    mlx_array update,
    const int* start,
    size_t num_start,
...
extern "C" mlx_array_result mlx_try_softmax(
    mlx_array a,
    const int* axes,
    size_t num_axes,
    bool precise,
...
extern "C" mlx_array_result
mlx_try_softmax_all(mlx_array a, bool precise, mlx_stream s) {
  MLX_C_ARRAY_TRY(mlx::core::softmax(a->ctx, precise, s->ctx))
}
extern "C" mlx_array_result mlx_try_sort(mlx_array a, int axis, mlx_stream s) {
  MLX_C_ARRAY_TRY(mlx::core::sort(a->ctx, axis, s->ctx))
}
extern "C" mlx_array_result mlx_try_sort_all(mlx_array a, mlx_stream s) {
...
extern "C" mlx_vector_array_result mlx_try_split(
    mlx_array a,
    const int* indices,
    size_t num_indices,
    int axis,
...
extern "C" mlx_array_result mlx_try_sqrt(mlx_array a, mlx_stream s) {
  MLX_C_ARRAY_TRY(mlx::core::sqrt(a->ctx, s->ctx))
}
extern "C" mlx_array_result mlx_try_square(mlx_array a, mlx_stream s) {
...
extern "C" mlx_array_result mlx_try_squeeze_all(mlx_array a, mlx_stream s) {
...
extern "C" mlx_array_result mlx_try_stack_all(
    const mlx_vector_array arrays,
    mlx_stream s) {
  MLX_C_ARRAY_TRY(mlx::core::stack(MLX_CPP_ARRVEC(arrays), s->ctx))
}
extern "C" mlx_array_result mlx_try_std(
    mlx_array a,
    const int* axes,
    size_t num_axes,
    bool keepdims,
...
extern "C" mlx_array_result mlx_try_stop_gradient(mlx_array a, mlx_stream s) {
  MLX_C_ARRAY_TRY(mlx::core::stop_gradient(a->ctx, s->ctx))
}
extern "C" mlx_array_result
mlx_try_subtract(mlx_array a, mlx_array b, mlx_stream s) {
  MLX_C_ARRAY_TRY(mlx::core::subtract(a->ctx, b->ctx, s->ctx))
}
extern "C" mlx_array_result mlx_try_sum(
    mlx_array a,
    const int* axes,
    size_t num_axes,
    bool keepdims,
...
extern "C" mlx_array_result
mlx_try_sum_all(mlx_array a, bool keepdims, mlx_stream s) {
...
extern "C" mlx_array_result
mlx_try_take_all(mlx_array a, mlx_array indices, mlx_stream s) {
  MLX_C_ARRAY_TRY(mlx::core::take(a->ctx, indices->ctx, s->ctx))
}
extern "C" mlx_array_result mlx_try_take_along_axis(
    mlx_array a,
    mlx_array indices,
    int axis,
    mlx_stream s) {
...
extern "C" mlx_array_result mlx_try_tan(mlx_array a, mlx_stream s) {
  MLX_C_ARRAY_TRY(mlx::core::tan(a->ctx, s->ctx))
}
extern "C" mlx_array_result mlx_try_tanh(mlx_array a, mlx_stream s) {
  MLX_C_ARRAY_TRY(mlx::core::tanh(a->ctx, s->ctx))
}
extern "C" mlx_array_result mlx_try_tensordot(
    mlx_array a,
    mlx_array b,
    const int* axes_a,
    size_t num_axes_a,
...
extern "C" mlx_array_result
mlx_try_topk(mlx_array a, int k, int axis, mlx_stream s) {
  MLX_C_ARRAY_TRY(mlx::core::topk(a->ctx, k, axis, s->ctx))
}
extern "C" mlx_array_result mlx_try_topk_all(mlx_array a, int k, mlx_stream s) {
  MLX_C_ARRAY_TRY(mlx::core::topk(a->ctx, k, s->ctx))
}
extern "C" mlx_array_result mlx_try_trace(
    mlx_array a,
    int offset,
    int axis1,
    int axis2,
...
extern "C" mlx_array_result mlx_try_transpose_all(mlx_array a, mlx_stream s) {
...
extern "C" mlx_array_result mlx_try_tril(mlx_array x, int k, mlx_stream s) {
  MLX_C_ARRAY_TRY(mlx::core::tril(x->ctx, k, s->ctx))
}
extern "C" mlx_array_result mlx_try_triu(mlx_array x, int k, mlx_stream s) {
  MLX_C_ARRAY_TRY(mlx::core::triu(x->ctx, k, s->ctx))
}
extern "C" mlx_array_result mlx_try_var(
    mlx_array a,
    const int* axes,
    size_t num_axes,
    bool keepdims,
...
extern "C" mlx_array_result mlx_try_zeros(
    const int* shape,
    size_t num_shape,
    mlx_array_dtype dtype,
    mlx_stream s) {
...
extern "C" mlx_array_result mlx_try_zeros_like(mlx_array a, mlx_stream s) {
