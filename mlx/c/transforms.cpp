...
extern "C" mlx_closure mlx_checkpoint(mlx_closure fun) {
  RETURN_MLX_C_PTR(new mlx_closure_((mlx::core::checkpoint((fun)->ctx))));
}
extern "C" mlx_closure mlx_custom_function(
  ...
  RETURN_MLX_C_PTR(new mlx_closure_((mlx::core::custom_function(
      (fun)->ctx,
...
extern "C" mlx_closure mlx_custom_vjp(
    ...
    mlx_closure_custom_function fun_vjp) {
  RETURN_MLX_C_PTR(
      new mlx_closure_((mlx::core::custom_vjp((fun)->ctx, (fun_vjp)->ctx))));
}
extern "C" void mlx_eval(const mlx_vector_array outputs) {
  return (mlx::core::eval(MLX_CPP_ARRVEC(outputs)));
}
extern "C" mlx_tuple_vector_array_vector_array mlx_jvp(
    mlx_closure fun,
    const mlx_vector_array primals,
    const mlx_vector_array tangents) {
  RETURN_MLX_C_PTR(new mlx_tuple_vector_array_vector_array_((mlx::core::jvp(
...
mlx_value_and_grad(mlx_closure fun, const int* argnums, size_t num_argnums) {
  RETURN_MLX_C_PTR(new mlx_closure_value_and_grad_((mlx::core::value_and_grad(
...
extern "C" mlx_tuple_vector_array_vector_array mlx_vjp(
  ...
  RETURN_MLX_C_PTR(new mlx_tuple_vector_array_vector_array_((mlx::core::vjp(
