...
int mlx_vector_array_get(const mlx_vector_array vec, size_t idx, mlx_array);
...
int mlx_vector_int_get(const mlx_vector_int vec, size_t idx, int*);
...
int mlx_vector_vector_int_get(
    const mlx_vector_vector_int vec,
    size_t idx,
    mlx_vector_int);
...
int mlx_vector_string_set_data(
    ...
    const mlx_string* data,
    size_t size);
int mlx_vector_string_set_value(mlx_vector_string vec, const mlx_string val);
...
int mlx_vector_string_get(const mlx_vector_string vec, size_t idx, mlx_string);
