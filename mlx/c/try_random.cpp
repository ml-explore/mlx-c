...
extern "C" mlx_array_result mlx_random_try_bernoulli(
    mlx_array p,
    const int* shape,
    size_t num_shape,
    mlx_array key,
...
extern "C" mlx_array_result mlx_random_try_bits(
    const int* shape,
    size_t num_shape,
    int width,
    mlx_array key,
...
extern "C" mlx_array_result mlx_random_try_categorical_shape(
    mlx_array logits,
    int axis,
    const int* shape,
    size_t num_shape,
...
extern "C" mlx_array_result mlx_random_try_categorical_num_samples(
    mlx_array logits_,
    int axis,
    int num_samples,
    mlx_array key,
...
extern "C" mlx_array_result mlx_random_try_categorical(
    mlx_array logits,
    int axis,
    mlx_array key,
    mlx_stream s) {
...
extern "C" mlx_array_result mlx_random_try_gumbel(
    const int* shape,
    size_t num_shape,
...
extern "C" mlx_array_result mlx_random_try_key(uint64_t seed) {
  MLX_C_ARRAY_TRY(mlx::core::random::key(seed))
}
extern "C" mlx_array_result mlx_random_try_multivariate_normal(
    mlx_array mean,
    mlx_array cov,
    const int* shape,
    size_t num_shape,
...
extern "C" mlx_array_result mlx_random_try_normal(
    const int* shape,
    size_t num_shape,
    mlx_array_dtype dtype,
    float loc,
...
extern "C" mlx_array_result mlx_random_try_randint(
    mlx_array low,
    mlx_array high,
    const int* shape,
    size_t num_shape,
...
extern "C" mlx_vector_array_result mlx_random_try_split(
    mlx_array key,
    mlx_stream s) {
  MLX_C_ARRAYPAIR_TRY(mlx::core::random::split(key->ctx, s->ctx))
}
extern "C" mlx_array_result mlx_random_try_truncated_normal(
    mlx_array lower,
    mlx_array upper,
    const int* shape,
    size_t num_shape,
...
extern "C" mlx_array_result mlx_random_try_uniform(
    mlx_array low,
    mlx_array high,
    const int* shape,
    size_t num_shape,
